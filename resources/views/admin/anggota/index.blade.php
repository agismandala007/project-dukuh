                ...
                <div class="relative overflow-x-auto h-fit rounded bg-gray-50 p-3">
                    <table class="w-full text-sm text-left">
                        <tr class="bg-slate-100">
                            ...
                            <th scope="col" class="px-6 py-6 border">Jabatan</th>
                            <th scope="col" class="px-6 py-6 border">NIP</th>
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-6 border">{{ $item->jabatan }}</td>
                            <td class="px-6 py-6 border">{{ $item->nip }}</td>
                            <td class="px-6 py-6 border">
                                <div class="flex flex-col lg:flex-row justify-center">
                                    <a href="{{ route('admin.anggota.edit', ['id' => $item->id]) }}"
                                    ...
                                    <form action="{{ route('admin.anggota.delete', ['id' => $item->id]) }}"
                                        method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit"
                    ...
                    <div>
                        <a href="{{ route('admin.anggota.input') }}"
