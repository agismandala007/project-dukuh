...
<body>
    ...
    <div class="flex flex-col gap-8 p-4 mx-auto mt-14">
        <div class="block w-full lg:w-3/6 mx-auto p-6 bg-white border border-gray-200 rounded-lg shadow">
            <form class="mx-auto" action="{{ route('admin.agenda.store') }}" method="post">
                @csrf
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <div class="text-red-500 text-sm">Tanggal Kegiatan harus diisi!!!</div>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="lokasi" name="lokasi"
                        class="form-input  @error('lokasi') border-red-500 @enderror" value="{{ old('lokasi') }}" />
                    @error('lokasi')
                    <div class="text-red-500 text-sm">Lokasi harus diisi!!!</div>
                    @enderror
                </div>
