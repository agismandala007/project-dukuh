        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
            <div class="flex items-center space-x-5 rtl:space-x-reverse">
                <div class="flex flex-row">
                    <img src="{{ asset('img/call.svg') }}" alt="" class="w-auto h-fit">
                    <span class="self-center text-xs whitespace-nowrap mx-2">022-6623181</span>
                </div>
|
                <div class="flex flex-row">
                    <img src="{{ asset('img/mail.svg') }}" alt="" class="w-auto h-fit">
            ...
            <div class="flex items-center space-x-6 rtl:space-x-reverse">
                <div class="flex flex-row">
                    <img src="{{ asset('img/world.svg') }}" alt="" class="w-auto h-fit">
    ...
    <nav class="bg-white border-gray-200">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('img/logo-dukuh.png') }}" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap">Padukuhan Pantog
                    Kulon</span>
            </a>
                ...
                <ul
                    ...
                    <li>
                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                            class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto">Profile Padukuhan
                        ...
                        <div id="dropdownNavbar"
                            ...
                            <ul class="py-2 text-sm text-gray-700"
                                ...
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 hover:bg-gray-100">Stuktur Padukuhan</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        <a href="{{ route('demografis') }}"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Data Penduduk</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Agenda Kegiatan</a>
                    </li>
                    <li>
                        <a href="#"
